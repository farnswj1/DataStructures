 ...
 * test.cpp
 * 
 * This program tests the min heap by reading a file full of input data.
...
int main(int argc, char* argv[]){
	...
	MinHeap<string>* data = new MinHeap<string>(750000);
	...
	cout << "Min value: " << data->minNode()->SSN << endl;
	cout << "Time elapsed: " << duration << endl;

	// Checks if the heap maintains the min heap property
	if (data->hasMinProperty()) {
		cout << "This heap maintains the min heap property." << endl;
	} else {
		cout << "This heap does NOT maintain the min heap property." << endl;
	}

	// Deletes the min heap
	delete data;
